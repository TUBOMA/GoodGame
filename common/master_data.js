...
const GameMasterData = {
  achievements: [
      ...
      { id: 'achieve_i_play_1', name: '回避の洗礼', desc: 'イライラ棒を1回プレイ', flavor: '手の震えは恐怖か、それとも興奮か。', game: 'i', category: 'play', tier: 1 },
      { id: 'achieve_i_play_10', name: '鋼の精神', desc: 'イライラ棒を10回プレイ', flavor: '焦燥感と上手く付き合えるようになってきた。', game: 'i', category: 'play', tier: 2 },
      { id: 'achieve_i_play_100', name: 'イライラマスター', desc: 'イライラ棒を100回プレイ', flavor: '悟りを開いたかのように冷静な指捌き。', game: 'i', category: 'play', tier: 3 },
      ...
      { id: 'achieve_i_clear_100', name: 'イライラ棒の支配者', desc: 'イライラ棒を100回クリア', flavor: 'もはやイライラ棒と一体化している。', game: 'i', category: 'clear', tier: 3 },
      { id: 'achieve_i_speedrun', name: '音速の走破', desc: 'イライラ棒を７秒未満でクリア', flavor: '瞬きする間にゴールに到達した。', game: 'i', category: 'skill', tier: 1 },
      { id: 'achieve_i_death_10', name: '不屈の挑戦者', desc: 'イライラ棒で1プレイで10回以上死ぬ', flavor: '痛みを知っても、何度でも繰り返す。', game: 'i', category: 'skill', tier: 2 },
